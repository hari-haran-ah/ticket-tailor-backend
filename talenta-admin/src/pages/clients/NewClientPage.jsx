...
export default function NewClientPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setGlobalError(err.response?.data?.detail || 'Failed to create client')
            setLoading(false)
        }
    }
                    ...
                    <form onSubmit={handleSubmit} className="p-5 md:p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" placeholder="https://client.yourdomain.com" {...fieldProps('domain_name')} required />
                                    </div>
                                    {errors.domain_name
                        ...
                        <div className="flex items-center gap-3 py-1">
                            ...
                            <label htmlFor="is_active" className="text-sm font-medium text-zinc-700 dark:text-zinc-300 cursor-pointer select-none">
                                Set client as <span className="font-semibold text-zinc-900 dark:text-zinc-100">Active</span> immediately
                            </label>
                        </div>
                        ...
                        <div className="flex justify-end gap-3 pt-2 border-t border-zinc-200 dark:border-zinc-800">
                            ...
                            <button
                                disabled={loading}
                                className="btn-primary h-9 px-5 font-semibold flex items-center justify-center gap-1.5"
                            >
